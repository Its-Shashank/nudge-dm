...
export const metadata: Metadata = {
  title: "Sign Up | NudgeDM",
  description: "Create your NudgeDM account to start automating your Instagram DMs.",
};
      ...
      <section className="flex w-full flex-1 items-center justify-center bg-white px-6 py-16 sm:px-12 lg:w-1/2">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8 space-y-1">
            <h1 className="text-headline-lg text-ink">Create your account</h1>
            <p className="text-body-md text-on-surface-variant">
              Start turning comments into customers today.
            </p>
          </div>
