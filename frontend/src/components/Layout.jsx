  ...
  return (
    <div className="flex h-screen surface" data-testid="app-layout">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <header className="surface-container-lowest px-8 py-4 flex items-center justify-between border-b border-[hsl(var(--outline-variant)_/_0.15)]" data-testid="app-header">
          ...
          <div className="flex items-center gap-4">
            {instagramConnected && (
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full surface-container-high" data-testid="instagram-status">
