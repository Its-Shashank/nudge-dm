      ...
      <div className="max-w-7xl mx-auto p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl gradient-primary text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <h2 className="text-4xl font-display font-bold mb-2">
                ${metrics?.total_active_revenue?.toLocaleString() || 0}
              </h2>
              <div className="flex items-center gap-1.5 text-sm">
                <TrendingUp className="w-4 h-4" />
                <span className="font-medium">+{metrics?.revenue_change || 0}%</span>
          ...
          <div className="p-6 rounded-2xl surface-container-lowest">
            ...
            <h2 className="text-4xl font-display font-bold text-on-surface mb-1">
              {metrics?.live_campaigns || 0}
            </h2>
            <p className="text-sm text-on-surface-variant">
              {metrics?.pending_campaigns || 0} Pending approval
            </p>
          </div>
        ...
        <div className="surface-container-lowest rounded-2xl p-6">
          ...
          <div className="flex items-center justify-between mt-6">
            <p className="text-sm text-on-surface-variant">
              Showing 1-4 of {campaigns.length} campaigns
            </p>
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" disabled data-testid="pagination-prev">
                Previous
              </Button>
              <Button variant="outline" size="sm" className="gradient-primary text-white" data-testid="pagination-1">
                1
              </Button>
              <Button variant="outline" size="sm" data-testid="pagination-2">
                2
              </Button>
              <Button variant="outline" size="sm" data-testid="pagination-3">
                3
              </Button>
